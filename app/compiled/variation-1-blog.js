...
const BLOG_ARCHIVE = [{
  issue: 'Vol. VII · No. 09',
  date: 'Jan 19, 2026',
  title: 'Twelve questions we now ask every first-time applicant.',
  read: '6 min'
}, {
  issue: 'Vol. VII · No. 08',
  date: 'Jan 12, 2026',
  title: 'What a "soft pull" actually is, in language a bureau doesn\'t use.',
  read: '4 min'
}, {
  issue: 'Vol. VII · No. 07',
  date: 'Jan 05, 2026',
  title: 'The holiday cash-flow gap: three charts, one recommendation.',
  read: '5 min'
}, {
  issue: 'Vol. VII · No. 06',
  date: 'Dec 22, 2025',
  title: 'We funded $47M in December. Here\'s where it went.',
  read: '4 min'
}, {
  issue: 'Vol. VII · No. 05',
  date: 'Dec 15, 2025',
  title: 'Why our origination fee is a flat $395, forever.',
  read: '3 min'
}, {
  issue: 'Vol. VII · No. 04',
  date: 'Dec 08, 2025',
  title: 'A receipt-per-customer dashboard for small-batch operators.',
  read: '8 min'
}, {
  issue: 'Vol. VII · No. 03',
  date: 'Dec 01, 2025',
  title: 'The renewal conversation: a checklist for the operator side.',
  read: '6 min'
}, {
  issue: 'Vol. VII · No. 02',
  date: 'Nov 24, 2025',
...
function BlogMeta({
  ...
  }, React.createElement("span", null, post.issue), React.createElement("span", {
    "aria-hidden": true,
    style: {
      opacity: 0.4
    }
  }, "\xB7"), React.createElement("span", null, post.date), React.createElement("span", {
    "aria-hidden": true,
    style: {
      opacity: 0.4
    }
  }, "\xB7"), React.createElement("span", null, post.read));
}
function BlogPlate({
  seed = 0,
  aspect = '16/10',
  ...
  const hue = Math.floor(rand(seed * 7.1) * 30) + 250;
  ...
  return React.createElement("div", {
  ...
  }, shapes.map((s, i) => React.createElement("circle", {
    key: i,
    cx: s.cx,
    cy: s.cy,
    r: s.r,
    ...
    textTransform: "uppercase"
  }, "FIG. ", String(seed).padStart(2, '0'))), React.createElement("div", {
    "aria-hidden": true,
    style: {
      position: 'absolute',
      inset: 0,
...
function BlogMasthead({
  ...
  }, React.createElement("span", null, "Vol. VII \xB7 Q1 2026 \xB7 No. 14"), React.createElement("span", null, "Delt Capital Editorial \xB7 Est. 2019"), React.createElement("span", {
    style: {
      color: accent,
      display: 'flex',
      alignItems: 'center',
  ...
  }), "Publishing weekly")), React.createElement("div", {
  ...
  }, "Underwriting dispatches, pricing letters, and operator field notes from the people who actually size your offer. One long read and a few short ones, most Wednesdays.", React.createElement("div", {
    style: {
      marginTop: 22,
      display: 'flex',
      alignItems: 'center',
  ...
  }, React.createElement("span", null, BLOG_POSTS.length + BLOG_ARCHIVE.length, " dispatches"), React.createElement("span", {
    "aria-hidden": true,
    style: {
      opacity: 0.4
    }
  }, "\xB7"), React.createElement("span", null, "6 authors"), React.createElement("span", {
    "aria-hidden": true,
    style: {
      opacity: 0.4
    }
  }, "\xB7"), React.createElement("span", null, "~1,800 readers"))))));
}
function BlogFeatured({
  ...
  }), "This week's lead"), React.createElement(BlogMeta, {
    post: post
  })), React.createElement("div", {
    "data-v1-grid-2col": true,
    style: {
  ...
  }, post.kicker), React.createElement("h2", {
    "data-v1-section-title": true,
    style: {
      fontFamily: V1.fontDisplay,
  ...
  }, "tl;dr"), post.tldr), React.createElement("div", {
    style: {
      marginTop: 28,
      display: 'flex',
      alignItems: 'center',
  ...
  }, React.createElement(BlogAvatar, {
    name: post.author.n,
    size: 34
  ...
  }, post.author.n), React.createElement("div", {
    style: {
      fontFamily: V1.fontMono,
      fontSize: 10.5,
  ...
  }, post.author.r)), React.createElement("span", {
    style: {
      flex: 1
    }
  }), React.createElement("span", {
  ...
  }, "Read the full piece", React.createElement("svg", {
    width: "14",
    height: "14",
    viewBox: "0 0 14 14"
  ...
  }, "Plate 14 \u2014", React.createElement("br", null), "The scorecard,", React.createElement("br", null), "in pieces")))));
}
function BlogCategoryBar({
  activeK,
  onSelect,
  counts,
  accent
...
function BlogCard({
  ...
  return React.createElement("a", {
    ...
    style: {
      ...
      padding: 20,
      borderRadius: 14,
      border: `1px solid ${hover ? V1.ink : 'transparent'}`,
  ...
  }, React.createElement("span", null, post.kicker), React.createElement("span", {
    "aria-hidden": true,
    style: {
      opacity: 0.4,
      color: V1.muted
  ...
  }, post.read)), React.createElement("h3", {
    style: {
      fontFamily: V1.fontDisplay,
      fontSize: 22,
      fontWeight: 600,
  ...
  }, post.author.n), React.createElement("span", {
    style: {
      flex: 1
    }
  }), React.createElement("div", {
...
function BlogSeriesRail({
  ...
  }, "The Floor Rate.", React.createElement("br", null), React.createElement("em", {
    style: {
      fontFamily: '"Source Serif Pro", Georgia, serif',
      fontStyle: 'italic',
      fontWeight: 400,
  ...
  }, "Monthly letters"), " from our lead underwriter.")), React.createElement("p", {
    style: {
      fontFamily: V1.fontBody,
      fontSize: 16,
      lineHeight: 1.55,
  ...
  }, "A plain-language dispatch from the desk that sizes your offer. No marketing review, no comms team \u2014 just what she'd say across the phone, on the record.")), React.createElement("div", {
  ...
  }, React.createElement("span", null, p.issue), React.createElement("span", {
    "aria-hidden": true,
    style: {
      opacity: 0.4,
      color: 'rgba(255,255,255,0.5)'
  ...
  }, p.deck), React.createElement("div", {
    style: {
      marginTop: 4,
      paddingTop: 14,
  ...
  }, p.author.n), React.createElement("span", {
    style: {
      flex: 1
    }
  }), React.createElement("span", {
...
function BlogArchive({
  ...
  return React.createElement("section", {
  ...
  }, React.createElement("div", null, React.createElement(V1Eyebrow, null, "Archive"), React.createElement("h2", {
    "data-v1-section-title": true,
    style: {
      fontFamily: V1.fontDisplay,
      fontSize: 32,
  ...
  }, "Older dispatches."), React.createElement("p", {
    style: {
      fontFamily: V1.fontBody,
      fontSize: 14.5,
      lineHeight: 1.55,
  ...
  }, "Every piece we've published, by issue. Searchable \u2014 and the full back-catalog is downloadable as a single PDF for long flights."), React.createElement("button", {
    style: {
      marginTop: 22,
      padding: '10px 16px',
      borderRadius: 8,
  ...
  }, "Download archive (PDF)", React.createElement("svg", {
    width: "13",
    height: "13",
    viewBox: "0 0 14 14"
  }, React.createElement("path", {
    ...
    strokeLinecap: "round",
    strokeLinejoin: "round"
  })))), React.createElement("div", null, BLOG_ARCHIVE.map((a, i) => React.createElement("a", {
    key: i,
    style: {
      display: 'grid',
  ...
  }, React.createElement("div", null, a.issue), React.createElement("div", {
    style: {
      marginTop: 3,
      color: V1.muted,
      opacity: 0.7
  ...
  }, a.read, React.createElement("svg", {
    width: "12",
    height: "12",
    viewBox: "0 0 12 12"
  }, React.createElement("path", {
...
function BlogNewsletter({
  ...
  return React.createElement("section", {
  ...
  }, React.createElement("div", null, React.createElement(V1Eyebrow, null, "Subscribe"), React.createElement("h2", {
    "data-v1-section-title": true,
    style: {
      fontFamily: V1.fontDisplay,
  ...
  }, "One long read, a few short ones,", ' ', React.createElement("em", {
    style: {
      fontFamily: '"Source Serif Pro", Georgia, serif',
      fontStyle: 'italic',
      fontWeight: 400,
  ...
  }, "most Wednesdays.")), React.createElement("p", {
    style: {
      fontFamily: V1.fontBody,
      fontSize: 16,
      lineHeight: 1.55,
  ...
  }, React.createElement("span", null, "~1,800 readers"), React.createElement("span", {
    "aria-hidden": true,
    style: {
      opacity: 0.4
    }
  }, "\xB7"), React.createElement("span", null, "52 issues / year"), React.createElement("span", {
    "aria-hidden": true,
    style: {
      opacity: 0.4
    }
  }, "\xB7"), React.createElement("span", null, "No sales mail"))), React.createElement("div", null, React.createElement("form", {
    onSubmit: e => {
      e.preventDefault();
  ...
  }, !submitted ? React.createElement(React.Fragment, null, React.createElement("label", {
    style: {
      display: 'block',
      fontFamily: V1.fontMono,
      fontSize: 10.5,
    ...
    onBlur: e => {
      e.target.style.borderColor = V1.line;
    }
  ...
  }, "Subscribe", React.createElement("svg", {
    width: "12",
    height: "12",
    viewBox: "0 0 14 14"
  }, React.createElement("path", {
  ...
  }, "By subscribing you agree to receive 1 email a week from the Delt Capital editorial desk. We don't share your address.")) : React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: '20px 8px'
    }
  ...
  }, "Subscribed."), React.createElement("div", {
    style: {
      marginTop: 6,
      fontFamily: V1.fontBody,
      fontSize: 14,
  ...
  }, "Confirmation on its way to ", React.createElement("b", {
    style: {
      color: V1.ink
    }
  }, email), ". Next issue lands Wednesday 6:00am ET."))), React.createElement("div", {
    style: {
      marginTop: 18,
      padding: '16px 20px',
      background: V1.white,
  ...
  }, "Rather talk than read?"), React.createElement("div", {
    style: {
      fontFamily: V1.fontBody,
      fontSize: 13,
      color: V1.muted,
  ...
  }, "30 min with an underwriter, on Teams.")), React.createElement("button", {
    onClick: onTalk,
    style: {
      padding: '8px 14px',
      borderRadius: 8,
...
function V1BlogPage({
  ...
  const filtered = activeK === 'all' ? gridSource : gridSource.filter(p => p.cat === activeK);
  ...
  }, React.createElement(BlogMasthead, {
    accent: accentColor
  }), React.createElement(BlogFeatured, {
    post: featured,
    accent: accentColor
  }), React.createElement(BlogCategoryBar, {
    activeK: activeK,
    onSelect: setActiveK,
    counts: counts,
    accent: accentColor
  ...
  }, React.createElement(V1Eyebrow, null, "Recent dispatches"), React.createElement("div", {
    style: {
      fontFamily: V1.fontMono,
      fontSize: 10.5,
      fontWeight: 500,
  ...
  }, "Showing ", filtered.length, " of ", gridSource.length)), filtered.length === 0 ? React.createElement("div", {
    style: {
      padding: '80px 0',
      textAlign: 'center',
      fontFamily: V1.fontBody,
  ...
  }, "Nothing published in this category yet."), React.createElement("p", {
    style: {
      fontSize: 14.5,
      maxWidth: 420,
      margin: '0 auto'
    }
  }, "Try another tag, or browse the archive below.")) : React.createElement("div", {
    "data-v1-grid-3col": true,
    style: {
      display: 'grid',
      gridTemplateColumns: 'repeat(3, 1fr)',
  ...
  }, filtered.map((p, i) => React.createElement(BlogCard, {
    key: p.id,
    post: p,
    seed: i + 1,
    accent: accentColor
  }))))), React.createElement(BlogSeriesRail, {
    posts: series,
    accent: accentColor
  }), React.createElement(BlogArchive, {
    accent: accentColor
  }), React.createElement(BlogNewsletter, {
    accent: accentColor,
    onTalk: onTalk
  }));
}
