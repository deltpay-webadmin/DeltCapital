...
const {
  useState: v1cUseState,
  useEffect: v1cUseEffect,
  useRef: v1cUseRef
} = React;
function v1fmtK(n) {
...
function V1CalcSpinner() {
  return React.createElement("div", {
    ...
    viewBox: "0 0 56 56",
    style: {
      animation: 'v1LeadSpin 1100ms linear infinite'
    }
  ...
  }, React.createElement(V1CalcIcon, {
    kind: "spark"
  })));
}
...
function V1CalcIcon({
  ...
  if (kind === 'x') return React.createElement("svg", p, React.createElement("path", {
    d: "M4 4L10 10M10 4L4 10"
  }));
  if (kind === 'arr') return React.createElement("svg", p, React.createElement("path", {
    d: "M3 7h8M8 4l3 3-3 3"
  }));
  if (kind === 'bolt') return React.createElement("svg", _extends({}, p, {
    fill: "currentColor",
    stroke: "none"
  ...
  if (kind === 'rocket') return React.createElement("svg", p, React.createElement("path", {
    d: "M7 1C5 3 4 6 4 9l2 2c3 0 6-1 8-3L11 5 7 1z"
  }), React.createElement("path", {
    d: "M4 9l-2 3 3-2"
  }));
  return null;
}
function V1CalcMoneyInput({
  value,
  onChange,
  onBlur,
  placeholder = '0',
  ...
  return React.createElement("div", {
    ...
    style: {
      width: '100%',
      padding: big ? '14px 16px 14px 36px' : '11px 14px 11px 32px',
      background: V1.bg,
...
function V1CalcPill({
  ...
  return React.createElement("button", {
    ...
    onMouseEnter: e => {
      if (!active) e.currentTarget.style.borderColor = `${V1.blue}66`;
    },
    onMouseLeave: e => {
      if (!active) e.currentTarget.style.borderColor = V1.line;
    }
  }, icon && React.createElement(V1CalcIcon, {
    kind: icon
  }), children);
}
function V1CalcHowLink({
  onClick
}) {
  ...
  return React.createElement("button", {
    ...
    style: {
      ...
      transform: !shown ? 'translateY(6px)' : hover ? 'translateY(-1px)' : 'translateY(0)',
      opacity: shown ? 1 : 0,
  ...
  }), "How it works", React.createElement("span", {
    "aria-hidden": true,
    style: {
      display: 'inline-flex',
...
function V1CalcHowInlineLink({
  ...
  return React.createElement("button", {
    ...
    kind: "spark"
  })), React.createElement("span", null, "Curious how it works?"), React.createElement("span", {
    "aria-hidden": true,
    style: {
      display: 'inline-flex',
      transform: hover ? 'translateX(3px)' : 'translateX(0)',
...
function V1CalcAnalyzer({
  ...
  const [acceptsCards, setAcceptsCards] = v1cUseState(null);
  ...
  const [leadStage, setLeadStage] = v1cUseState('idle');
  const [theaterPhase, setTheaterPhase] = v1cUseState(0);
  ...
  const hasTIB = tib !== '';
  let baseLow = revenue * 0.5,
    baseHigh = revenue * 0.67;
  ...
  const leadValid = leadFirst.trim().length >= 1 && leadBiz.trim().length >= 1 && emailValid && phoneValid;
  const onLeadPhone = raw => {
    ...
    d = d.slice(0, 10);
    let f = d;
    if (d.length > 6) f = `(${d.slice(0, 3)}) ${d.slice(3, 6)}-${d.slice(6)}`;else if (d.length > 3) f = `(${d.slice(0, 3)}) ${d.slice(3)}`;else if (d.length > 0) f = `(${d}`;
    setLeadPhone(f);
  };
  ...
  return React.createElement("div", {
  ...
  }, React.createElement(V1Eyebrow, null, "Live calculator"), React.createElement("h2", {
  ...
  }, "How much could you qualify for?"), React.createElement("p", {
    style: {
      fontSize: 15,
      color: V1.muted,
      fontFamily: V1.fontBody,
  ...
  }, "Enter your details. See your funding estimate instantly.")), React.createElement("div", {
    ...
    style: v1CardStyle
  }, React.createElement(V1CalcLabel, null, "Monthly revenue"), React.createElement(V1CalcMoneyInput, {
    value: revenueInput,
    onChange: onRevenue,
  ...
  }, "Up to $250,000")), hasRevenue && React.createElement("div", {
    style: v1CardStyle
  }, React.createElement(V1CalcLabel, null, "Time in business"), React.createElement("div", {
    "data-v1-grid-2col": true,
    style: {
      display: 'grid',
    ...
    v: '2yr+',
    l: '2+ years'
  }].map(o => React.createElement(V1CalcPill, {
    key: o.v,
    active: tib === o.v,
    onClick: () => setTib(tib === o.v ? '' : o.v)
  }, o.l)))), hasTIB && React.createElement("div", {
    style: v1CardStyle
  }, React.createElement(V1CalcLabel, null, "Do you currently accept credit cards?"), React.createElement("div", {
    "data-v1-grid-2col": true,
    style: {
      display: 'grid',
      gridTemplateColumns: '1fr 1fr',
  ...
  }, React.createElement(V1CalcPill, {
    active: acceptsCards === true,
    onClick: () => onSelectCards(true),
    icon: "check"
  }, "Yes"), React.createElement(V1CalcPill, {
    active: acceptsCards === false,
    onClick: () => onSelectCards(false),
    icon: "x"
  }, "No")), acceptsCards === true && React.createElement("div", {
    style: {
      marginTop: 16,
      paddingTop: 16,
      borderTop: `1px solid ${V1.line}`
    }
  }, React.createElement(V1CalcLabel, null, "Monthly card sales"), React.createElement(V1CalcMoneyInput, {
    big: false,
    value: cardSalesInput,
    onChange: onCardSales,
    onBlur: () => cardSales > 0 && setCardSalesInput(Math.round(cardSales).toLocaleString())
  })))), React.createElement("div", {
    style: {
      position: 'relative',
      background: hasRevenue && boosted ? `linear-gradient(145deg, ${V1.bg} 0%, #F4EEFB 50%, ${V1.bg} 100%)` : V1.bg,
  ...
  }, React.createElement(V1CalcLabel, null, "Estimated funding range"), React.createElement("div", {
    style: {
      padding: '4px 0'
    }
  }, React.createElement("span", {
    style: {
      ...
      color: !hasRevenue ? '#d1d5db' : boosted ? V1.blue : V1.ink,
      fontVariantNumeric: 'tabular-nums',
      transition: 'color .4s'
    }
  }, hasRevenue && showResults ? React.createElement(React.Fragment, null, v1fmtK(displayLow), React.createElement("span", {
    style: {
      margin: '0 6px',
      opacity: 0.35
    }
  }, "\u2013"), v1fmtK(displayHigh)) : hasRevenue && allFilled ? React.createElement("span", {
    style: {
      color: V1.muted,
      fontSize: '0.7em',
      fontWeight: 600,
  ...
  }, "Calculating\u2026") : React.createElement("span", {
    style: {
      color: '#d1d5db'
    }
  ...
  }, !hasRevenue ? 'Complete the fields to see your estimate.' : boosted ? 'With Delt processing' : 'Based on your monthly revenue'), hasRevenue && boosted && React.createElement("div", {
    style: {
      marginTop: 14
    }
  }, React.createElement("span", {
    ...
    kind: "spark"
  }), "0% processing on your first $5,000")), hasRevenue && isRedirect && React.createElement("div", {
    onClick: onNavProcessing,
    role: onNavProcessing ? 'button' : undefined,
    tabIndex: onNavProcessing ? 0 : undefined,
    onKeyDown: onNavProcessing ? e => {
    ...
    onMouseEnter: e => {
      if (onNavProcessing) {
        e.currentTarget.style.background = `${V1.blue}0D`;
        e.currentTarget.style.borderColor = `${V1.blue}55`;
      }
    },
    onMouseLeave: e => {
      if (onNavProcessing) {
        e.currentTarget.style.background = `${V1.blue}05`;
        e.currentTarget.style.borderColor = `${V1.blue}22`;
      }
    }
  }, React.createElement("div", {
    style: {
  ...
  }, "Get started with Delt today."), React.createElement("div", {
    style: {
      fontSize: 12,
      color: V1.muted,
      lineHeight: 1.5,
  ...
  }, "New businesses that process with Delt get a pre-approved offer and up to 2\xD7 more capital as they grow."), onNavProcessing && React.createElement("div", {
    style: {
      marginTop: 10,
      fontSize: 11.5,
      fontWeight: 600,
  ...
  }, "See how it works \u2192")), React.createElement("p", {
    style: {
      fontSize: 10.5,
      color: V1.muted,
      opacity: 0.75,
  ...
  }, "Estimates are approximate and not a guarantee of funding. Final offers are based on a full review of your business.")), React.createElement("div", {
    style: {
      marginTop: 20,
      marginLeft: -28,
      marginRight: -28,
      marginBottom: -28,
      background: deltToggle ? `linear-gradient(135deg, ${V1.blue}0A 0%, ${V1.blue}14 100%)` : `${V1.bg}`,
      borderTop: `1px solid ${deltToggle ? V1.blue + '22' : V1.line}`,
      transition: 'background .3s, border-color .3s'
    }
  }, deltToggle && hasRevenue && !isRedirect && React.createElement("div", {
    style: {
      padding: '14px 28px 0'
    }
  }, React.createElement(V1CalcHowInlineLink, {
    onClick: onNavHow
    ...
    style: {
      ...
      border: 'none',
      background: 'transparent',
      cursor: noCards ? 'default' : 'pointer',
      textAlign: 'left',
      display: 'flex',
      alignItems: 'center',
    ...
    style: {
      fontSize: 13.5,
      fontWeight: 600,
      color: deltToggle ? V1.ink : V1.muted,
      transition: 'color .3s'
    }
  }, noCards ? 'Sign up for Delt payments for 25% more capital' : 'Switch processing to Delt for 25% more capital'), deltToggle && hasRevenue && !isRedirect && React.createElement("div", {
    style: {
      fontSize: 11.5,
      color: V1.blue,
      fontWeight: 500,
  ...
  }, v1fmtK(preLow), " \u2192 ", v1fmtK(bLow), "\u2013", v1fmtK(bHigh)))), React.createElement("div", {
    style: {
      position: 'relative',
      width: 44,
      height: 26,
  ...
  }, "One review, two yeses."), ' ', "Delt is built so a single underwriting decision covers your capital ", React.createElement("em", null, "and"), " your merchant services\u2014with lower processing fees baked in."))))), showTheater && React.createElement("div", {
    "aria-live": "polite",
    style: {
      position: 'absolute',
      inset: 0,
  ...
  }, React.createElement(V1CalcSpinner, null), React.createElement("div", {
    style: {
      marginTop: 22,
      width: '100%',
      maxWidth: 320
    }
  }, ['Analyzing your monthly volume…', 'Matching capital partners…', 'Pre-qualifying your offer…'].map((line, i) => React.createElement("div", {
    key: i,
    style: {
      display: 'flex',
      alignItems: 'center',
  ...
  }, theaterPhase > i ? React.createElement(V1CalcIcon, {
    kind: "check"
  }) : null), React.createElement("span", null, line))))), showGate && React.createElement("div", {
    style: {
      position: 'absolute',
      inset: 0,
      borderRadius: 20,
    ...
    kind: "spark"
  }), "Your offer is ready"), React.createElement("h3", {
    style: {
      margin: '12px 0 4px',
      fontFamily: V1.fontDisplay,
  ...
  }, "Where should we send it?"), React.createElement("p", {
    style: {
      margin: 0,
      fontFamily: V1.fontBody,
      fontSize: 12.5,
  ...
  }, "We'll text and email your full funding range now. No credit pull."), React.createElement("div", {
    style: {
      marginTop: 14,
      display: 'grid',
      gap: 8
    }
  }, React.createElement(V1LeadInput, {
    value: leadFirst,
    onChange: setLeadFirst,
  ...
  }, leadError), React.createElement("button", {
    onClick: submitLead,
    ...
    style: {
      ...
      background: !leadValid || leadSubmitting ? `${V1.blue}55` : `linear-gradient(135deg, ${V1.blue} 0%, #6366F1 50%, ${V1.blue} 100%)`,
      color: !leadValid || leadSubmitting ? 'rgba(255,255,255,0.7)' : '#fff',
      boxShadow: !leadValid || leadSubmitting ? 'none' : `0 10px 30px -10px ${V1.blue}AA, 0 4px 10px -4px ${V1.blue}77`,
  ...
  }, leadSubmitting ? 'Unlocking…' : 'Reveal my offer', !leadSubmitting && React.createElement(V1CalcIcon, {
    kind: "arr"
  })), React.createElement("div", {
    style: {
      marginTop: 8,
  ...
  }, "We'll never sell your info. Unsubscribe anytime.")))), React.createElement("div", {
    style: {
      padding: '0 40px 40px'
    }
  }, React.createElement("button", {
    ...
    style: {
      ...
      background: ctaDisabled ? `${V1.blue}55` : ctaBoosted ? `linear-gradient(135deg, ${V1.blue} 0%, #6366F1 50%, ${V1.blue} 100%)` : V1.blue,
    ...
    onMouseEnter: e => {
      if (!ctaDisabled) {
        ...
        e.currentTarget.style.boxShadow = `0 14px 40px -10px ${V1.blue}CC, 0 6px 14px -4px ${V1.blue}99`;
      }
    },
    onMouseLeave: e => {
      if (!ctaDisabled) {
...
function V1PhoneInput({
  ...
  }, V1_PHONE_COUNTRIES.map(c => React.createElement("option", {
    key: c.code,
    value: c.code
  }, c.label))), React.createElement("input", {
    type: "tel",
    value: value,
    onChange: e => onChange(e.target.value),
    onFocus: () => setFocused(true),
...
function V1CalculatorPage({
  ...
  return React.createElement("div", {
  ...
  }, React.createElement(V1Eyebrow, null, "Calculator"), React.createElement("h1", {
    "data-v1-section-title": true,
    style: {
      fontFamily: V1.fontDisplay,
  ...
  }, "See your funding estimate", ' ', React.createElement("em", {
    style: {
      fontStyle: 'italic',
  ...
  }, "instantly.")), React.createElement("p", {
    style: {
      fontFamily: V1.fontBody,
      fontSize: 18,
      lineHeight: 1.55,
  ...
  }, "Three questions. Soft pull only. Real numbers from the same underwriting logic that runs on every Delt application."))), React.createElement("section", {
    "data-v1-section": true,
    style: {
      padding: '0 24px 64px'
    }
  }, React.createElement(V1CalcAnalyzer, {
    onApply: onApply,
    onNavHow: onNavHow,
  ...
  }, React.createElement("div", null, React.createElement(V1Eyebrow, null, "Transparent math"), React.createElement("h2", {
    "data-v1-section-title": true,
    style: {
      ...v1H2,
      marginTop: 18
    }
  }, "How the numbers", React.createElement("br", null), "actually work.")), React.createElement("p", {
    style: {
      fontFamily: V1.fontBody,
      fontSize: 16,
      lineHeight: 1.6,
  ...
  }, "One multiplier \u2014 called a factor rate \u2014 replaces the APR gymnastics banks use. Here's every input, and every lever that moves your offer.")), React.createElement("div", {
    ...
    e: 'Formula',
    t: 'Monthly revenue × 50–67%',
    d: 'That range is the standard. Your factor multiplies it — we publish both.'
  }, {
    e: 'Factor rate',
    t: '1.12× – 1.22×',
    d: 'Longer time in business and larger advances pull the factor down. Median is 1.18×.'
  }, {
    e: 'Delt Boost',
    t: 'Up to 1.75×',
    d: 'Switch your card processing to Delt and we underwrite against projected deposits, not just historical ones.'
  }, {
    e: 'Repayment',
    t: '4–10 months',
    d: 'Fixed daily or weekly debit sized to your revenue. Schedule in your offer before you sign.'
  }, {
    e: 'Early-pay',
    t: 'Rebated pro-rata',
    d: 'Pay the advance off early and we return the unearned factor. Not standard in MCA — we wrote it into every contract.'
  }, {
    e: 'Prepayment',
    t: '$0 penalty',
    d: 'There is no prepayment penalty on any Delt product. Full stop.'
  ...
  }, React.createElement(V1Eyebrow, null, b.e), React.createElement("div", {
    style: {
      fontFamily: V1.fontDisplay,
      fontSize: 24,
      fontWeight: 700,
  ...
  }, b.d)))))), React.createElement("section", {
    "data-v1-section": true,
    style: {
      padding: '96px 40px'
    }
  ...
  }, "About the numbers you just saw.")), React.createElement(V1CalcFAQ, null))));
}
function V1CalcFAQ() {
