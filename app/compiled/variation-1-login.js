...
function V1LoginPage({
  ...
  const trustSignals = [{
    eyebrow: 'Compliance',
    body: 'SOC 2 Type II · audited Q1 2026'
  }, {
    eyebrow: 'Session',
    body: 'Expires in 20 min · browser-local only'
  }, {
    eyebrow: 'Last login',
    body: 'Oct 12 · Los Angeles (you)'
  }];
  const nowLabel = (() => {
    const d = new Date();
  ...
  return React.createElement("section", {
  ...
  }, "Vol. VII \xB7 Gate", React.createElement("span", {
    style: {
      width: 18,
      height: 1,
    ...
    color: V1.blueSoft
  }, "Sign in")), React.createElement("h1", {
    ...
    delay: 140,
    duration: 900
  }, "Welcome back,"), React.createElement(V1LineMask, {
    ready: mounted,
    delay: 250,
    duration: 900
  }, "operator.")), React.createElement("p", {
    style: {
      fontFamily: V1.fontBody,
      fontSize: 17,
      lineHeight: 1.55,
  ...
  }, "Your session is secured, soft-pulled, and auto-expires. We never store card data or factor terms in the browser."), React.createElement("div", {
    style: {
      marginTop: 48,
      paddingTop: 28,
  ...
  }, trustSignals.map((s, i) => React.createElement("div", {
  ...
  }, "PG. 01 / 01")), React.createElement("div", {
    style: {
      position: 'relative',
      background: '#ffffff',
    ...
    delay: 200,
    duration: 900
  }, "Sign in to your Delt account.")), React.createElement("div", {
    style: {
      marginTop: 36,
      height: 1,
      background: V1.line,
    ...
    style: enter(460)
  }, React.createElement(V1LoginField, {
    id: "login-email",
    label: "Email address",
    type: "email",
    value: email,
    ...
    }, showPassword ? React.createElement("svg", {
      width: "16",
      height: "16",
      viewBox: "0 0 16 16",
      fill: "none",
    ...
    style: {
      ...
      boxShadow: hoverSubmit ? `0 12px 28px -10px ${V1.blue}cc, 0 2px 6px ${V1.blue}44` : `0 6px 18px -8px ${V1.blue}aa`,
  ...
  }), "Sign in", React.createElement("svg", {
    width: "15",
    height: "15",
    viewBox: "0 0 14 14",
    style: {
  ...
  }, "or continue with"), React.createElement("span", {
    style: {
      flex: 1,
      height: 1,
      background: V1.line
  ...
  }].map(sso => React.createElement("button", {
    key: sso.k,
    type: "button",
  ...
  }, sso.icon, sso.label))), React.createElement("div", {
    style: {
      marginTop: 44,
      paddingTop: 24,
  ...
  }, "Not a customer yet?"), React.createElement("button", {
    type: "button",
    onClick: onApply,
  ...
  }, "Apply for funding", React.createElement("span", {
    style: {
      display: 'inline-flex',
  ...
  }, "By signing in you agree to", ' ', React.createElement("button", {
    type: "button",
  ...
  }, "Magic link sent."), React.createElement("p", {
    style: {
      marginTop: 20,
      fontFamily: V1.fontBody,
      fontSize: 17,
  ...
  }, "We emailed a sign-in link to", ' ', React.createElement("span", {
    style: {
      color: V1.ink,
      fontWeight: 500
    }
  }, email || 'operator@delt.capital'), ". Open it on this device to finish signing in."), React.createElement("div", {
    style: {
      marginTop: 24,
      display: 'inline-flex',
      alignItems: 'center',
  ...
  }), "Sent \xB7 ", nowLabel, " \xB7 expires in 10 min"), React.createElement("div", {
    style: {
      marginTop: 40,
      display: 'flex',
      gap: 12,
  ...
  }, "Resend link"), React.createElement("button", {
    type: "button",
    onClick: onClose,
    style: {
      display: 'inline-flex',
  ...
  }, "Back to site", React.createElement("svg", {
    width: "13",
    height: "13",
    viewBox: "0 0 14 14"
  }, React.createElement("path", {
