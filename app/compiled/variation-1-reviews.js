...
function ReviewCard({
  ...
  return React.createElement("article", {
    ...
    onMouseEnter: e => {
      ...
      e.currentTarget.style.boxShadow = featured ? '0 30px 60px -30px rgba(10,37,64,0.5)' : '0 20px 40px -24px rgba(10,37,64,0.18)';
    },
    onMouseLeave: e => {
  ...
  }), meta.kind || meta.industry), React.createElement("span", {
    style: {
      color: featured ? 'rgba(255,255,255,0.2)' : V1.line
    }
  ...
  }, meta.city), React.createElement("span", {
    style: {
      marginLeft: 'auto',
      display: 'inline-flex',
      alignItems: 'center',
  ...
  })), "Verified")), React.createElement("blockquote", {
    style: {
      margin: 0,
      fontFamily: V1.fontDisplay,
  ...
  }, React.createElement(FooterMetric, {
    featured: featured,
    label: "Funded",
    value: t.f,
    highlight: true
    ...
    featured: featured,
    label: meta.draw > 1 ? `Draw #${meta.draw}` : 'First draw',
    value: `${meta.years} yr`
  }), featured && React.createElement(FooterMetric, {
    featured: featured,
    label: "Saved vs bank",
    value: meta.savings
  })));
...
function FooterMetric({
  ...
  return React.createElement("div", null, React.createElement("div", {
    ...
    style: {
      ...
      fontWeight: 700,
      letterSpacing: '-0.02em',
      color: highlight ? featured ? V1.blueSoft : V1.blue : featured ? '#fff' : V1.ink,
      fontVariantNumeric: 'tabular-nums',
      lineHeight: 1.1
    }
  }, value));
}
function V1ReviewsPage({
  accent,
  onApply,
  onTalk
}) {
  const [filter, setFilter] = React.useState('All');
  const allReviews = DeltContent.testimonials.map((t, i) => ({
    ...t,
    _meta: REVIEW_META[i]
  }));
  const filtered = filter === 'All' ? allReviews : allReviews.filter(r => r._meta.industry === filter);
  return React.createElement(React.Fragment, null, React.createElement("section", {
  ...
  }, React.createElement(V1Eyebrow, null, "Operators"), React.createElement("div", {
  ...
  }, "Every quote is from a borrower who has closed at least once. Business names are real, on request. We publish the factor and funding amount beside each story \u2014 no anonymized marketing fluff.")), React.createElement("div", {
    ...
    value: '1,847',
    sub: 'Post-funding, every deal'
  }, {
    label: 'Net Promoter Score',
    value: '72',
    sub: 'Industry avg: 44'
  }, {
    label: 'Would refinance again',
    value: '94%',
    sub: 'Of closed borrowers'
  }, {
    label: 'Return customers',
    value: '2.4×',
    sub: 'Avg. draws per operator'
    ...
    return React.createElement("button", {
      ...
      onMouseEnter: e => {
        if (!isActive) e.currentTarget.style.background = V1.bgWarm;
      },
      onMouseLeave: e => {
        if (!isActive) e.currentTarget.style.background = 'transparent';
      }
    }, f, f !== 'All' && React.createElement("span", {
      style: {
        marginLeft: 8,
  ...
  }, filtered.map((t, i) => React.createElement(ReviewCard, {
    key: t.n,
    t: t,
    meta: t._meta,
  ...
  }, "No operators in this category yet. ", React.createElement("button", {
  ...
  }, "Show all")))), React.createElement("section", {
    "data-v1-section": true,
    style: {
      background: V1.white,
      padding: '56px 0',
  ...
  }), "Trusted & audited"), React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 48,
  ...
  }, ['TRUSTPILOT', 'BBB A+', 'SOC 2 TYPE II', 'PLAID PARTNER', 'FDIC PARTNER BANKS'].map((l, i) => React.createElement("span", {
    key: i,
    style: {
      fontFamily: V1.fontDisplay,
      fontSize: 15,
  ...
  }, l)))))), React.createElement(V1CTASection, {
    onApply: onApply,
    onTalk: onTalk
  }));
}
