...
const BLOG_POSTS = [
  ...
  {
    id: 'loan-fee-math-cfo',
    cat: 'pricing',
    issue: 'Vol. VII · No. 13',
    date: 'Mar 11, 2026',
    read: '7 min',
    kicker: 'Pricing, unpacked',
    title: 'The loan-fee math your CFO wishes you\'d send them.',
  ...
  },
  {
    ...
    read: '6 min',
    kicker: 'Competitive',
    title: 'The brokered-financing receipt we keep pinned above the underwriting desk.',
    deck: 'A screenshot of a 1.42× "daily" offer, a margin-note from the CEO, and the reason we turned down a $40M warehouse line.',
    tldr: 'A brokered revenue-based financing deal at 1.42× with 5% origination = 61% APR. We priced the same file at 1.16× with no origination. Receipt on file.',
    author: { n: 'Elena Morgan', r: 'Lead Underwriter' },
    tags: ['rbf', 'pricing', 'comparison'],
  },
  {
    id: 'restructure-call',
    cat: 'operators',
