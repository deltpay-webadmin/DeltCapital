  ...
  return (
    <section ref={heroRef} style={{
      ...
      >
        ...
        <img src="app/assets/washington-cutout.webp" alt="" />
      </div>
      <div className="v1hero-mobile-scrim" aria-hidden />

      <div data-v1-grid-2col data-v1-hero-grid style={{
        width: '100%',
...
function Variation1() {
  ...
  const body =
    page === 'about'   ? <V1AboutPage accent={accent} onApply={() => openApp(null, null)} onTalk={() => navTo('talk')} onCalc={() => navTo('calc')} /> :
