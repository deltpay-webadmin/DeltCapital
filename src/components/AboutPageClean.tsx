...
export function AboutPage({ onClose, onApplyClick, onCalculatorClick, onReviewsClick, onWinsClick }: AboutPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#fafbfc]">
      {/* Hero Section */}
      <section className="py-24 px-4 text-center bg-[#fafbfc]">
        <h1
          className="text-4xl sm:text-5xl md:text-6xl text-[#172b4d] dark:text-white mb-4 tracking-tight max-w-6xl mx-auto"
          style={{ fontWeight: 700 }}
        >
          {t.hero.title}
          <br />
          {t.hero.subtitle} <em className="text-[#0c66e4] not-italic" style={{ fontStyle: 'italic' }}>{t.hero.accent}</em>
        </h1>
      </section>

      {/* Who We Are Section */}
      <section className="py-16 px-4 bg-[#f1f2f4]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-[#172b4d] dark:text-white mb-16">
            {t.whoWeAre}
          </h2>
          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 mb-12">
              ...
              {/* Text Content */}
              <div className="w-full md:w-1/2">
                <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-[#172b4d] dark:text-white mb-6">
            ...
            <div className="flex items-center justify-center gap-8">
              ...
              <button
                onClick={prevSlide}
                className="w-12 h-12 rounded-full bg-[#0c66e4]/15 hover:bg-[#0c66e4]/25 text-[#0c66e4] flex items-center justify-center transition-all shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <button
                onClick={nextSlide}
                className="w-12 h-12 rounded-full bg-[#0c66e4] hover:bg-[#0055cc] text-white flex items-center justify-center transition-all shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-[#fafbfc] text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#172b4d] dark:text-white mb-8">
