...
export function ApplicationPage({ onClose, quizData, calculatorData, fromQuiz, onLegalLinkClick, onOpenPlaidOnboarding, plaidCompleted, onDeltLearnMore }: ApplicationPageProps) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="sticky top-0 z-30 bg-[#F7F5F0] border-b border-[#4F46E50F] shadow-sm isolate">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <button
            onClick={onClose}
            className="w-10 h-10 bg-[#F7F5F0] hover:bg-[#E4E7F0] rounded-full flex items-center justify-center transition-colors"
          >
