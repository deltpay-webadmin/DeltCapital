...
export function BlogPage({ onClose, onAboutClick, onHowItWorksClick, onReviewsClick, onBlogClick, onFAQClick, onSupportClick, onWinsClick, onApplyClick, onPrivacyClick, onTermsClick, onDisclosuresClick, onResourcesClick }: BlogPageProps) {
          ...
          <div className="min-h-screen">
            ...
            <div className="sticky top-0 bg-white/95 dark:bg-[#0A1F35]/95 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 z-10">
              <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                <button
                  ...
                  className="flex items-center gap-2 text-[#6B7280] hover:text-[#0c66e4] transition-colors"
                >
            ...
            <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              <motion.div
                ...
                className="mb-12"
              >
                <div className="inline-block px-3 py-1 bg-[#0c66e4]/10 text-[#0c66e4] rounded-full text-sm mb-4">
                  {selectedPost.category}
                </div>
                <h1 className="text-4xl lg:text-5xl text-[#172b4d] dark:text-white mb-6 leading-tight">
                  {selectedPost.title}
                </h1>
  ...
  return (
    ...
    >
      <div className="min-h-screen">
        {/* Header */}
        <div className="sticky top-0 bg-[#fafbfc] border-b border-[#172b4d]/10 z-10">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex items-center justify-between mb-6">
              <motion.div
                ...
                animate={{ y: 0, opacity: 1 }}
              >
                <h1 className="text-4xl text-[#172b4d] mb-1">
                  What's new
                </h1>
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
                      selectedCategory === category
                        ? 'bg-[#0c66e4] text-white shadow-lg shadow-[#0c66e4]/25'
                          ...
                          {dropdownCategories.map((category) => (
                            <button
                              ...
                              className={`w-full text-left px-4 py-2.5 rounded-lg text-sm transition-all flex items-center justify-between ${
                                selectedCategory === category
                                  ? 'bg-[#0c66e4]/10 text-[#0c66e4] font-medium'
              ...
              >
                <div className="flex flex-col md:flex-row gap-6 p-6 md:p-8">
                  ...
                  <div className="flex-1 order-2 md:order-1">
                    ...
                    <h2 className="text-2xl lg:text-3xl text-[#172b4d] dark:text-white mb-4 group-hover:text-[#0c66e4] dark:group-hover:text-[#5B57FF] transition-colors leading-tight">
                      {post.title}
                    </h2>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[#0c66e4] hover:text-[#0055cc] transition-colors inline-flex items-center gap-2 group-hover:gap-3">
                        Read more
