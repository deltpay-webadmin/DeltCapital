...
export function CalculatorCTA({ onCalculatorClick }: CalculatorCTAProps) {
  ...
  return (
    <section className="py-16 bg-[#F7F5F0] dark:bg-[#0F0E17]">
        ...
        <div className="bg-white dark:bg-[#0f1f2e] rounded-3xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div className="grid md:grid-cols-2 gap-0 items-stretch">
            ...
            <div className="p-12 md:p-16 flex flex-col justify-center">
              <div className="flex items-center gap-2 text-[#4F46E5] dark:text-white text-sm font-semibold mb-6">
              ...
              <button
                ...
                className="w-full bg-[#4F46E5] hover:bg-[#3730A3] text-white px-8 py-4 rounded-xl font-semibold text-base transition-all inline-flex items-center justify-center gap-2"
              >
            ...
            {/* Right Side - Visual */}
            <div className="relative h-full min-h-[500px] bg-[#4F46E5] p-12 md:p-16 flex items-center justify-center">
