...
export function CalculatorCTA({ onCalculatorClick }: CalculatorCTAProps) {
  ...
  return (
    <section className="py-16 bg-[#fafbfc] dark:bg-[#0A1F35]">
        ...
        <div className="bg-white dark:bg-[#0f1f2e] rounded-3xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div className="grid md:grid-cols-2 gap-0 items-stretch">
            ...
            <div className="p-12 md:p-16 flex flex-col justify-center">
              <div className="flex items-center gap-2 text-[#0c66e4] dark:text-white text-sm font-semibold mb-6">
              ...
              <button
                ...
                className="w-full bg-[#0c66e4] hover:bg-[#0055cc] text-white px-8 py-4 rounded-xl font-semibold text-base transition-all inline-flex items-center justify-center gap-2"
              >
            ...
            {/* Right Side - Visual */}
            <div className="relative h-full min-h-[500px] bg-[#0c66e4] p-12 md:p-16 flex items-center justify-center">
