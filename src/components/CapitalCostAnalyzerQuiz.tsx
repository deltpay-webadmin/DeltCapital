        ...
        <div className="text-center">
          ...
          >
            <div className="w-20 h-20 mx-auto mb-4">
              <svg className="animate-spin text-[#4F46E5]" viewBox="0 0 24 24">
          ...
          <motion.h3
            ...
            className="text-2xl font-bold text-[#0F0E17] mb-2"
          >
        ...
        <div className="text-center pt-11 pb-9 px-12">
          ...
          <motion.div
            ...
            style={{
              ...
              fontWeight: 800,
              color: isDeltBoosted ? '#4F46E5' : '#0B0B18',
              letterSpacing: '-2px',
              lineHeight: 1,
              marginBottom: '6px',
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                <div
                  style={{
                    ...
                    height: '40px',
                    borderRadius: '10px',
                    background: 'linear-gradient(135deg, #4F46E5 0%, #5B3AFF 100%)',
                    display: 'flex',
                    alignItems: 'center',
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                <div
                  style={{
                    ...
                    borderRadius: '10px',
                    background: deltToggle
                      ? 'linear-gradient(135deg, #4F46E5 0%, #5B3AFF 100%)'
                      : '#E5E7EB',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                ...
                <div
                  style={{
                    ...
                    height: '28px',
                    borderRadius: '14px',
                    background: deltToggle ? '#4F46E5' : '#CBD5E1',
                    padding: '3px',
            ...
            {isRedirectCase && (
              ...
              >
                ...
                >
                  ...
                  <p
                    className="text-[13px] text-[#0F0E17] mb-1"
          ...
          >
            ...
            <div className="mb-8">
              <div className="flex justify-between items-center mb-3">
                ...
                <span className="text-sm text-[#6A6876]">
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-12 h-12 bg-[#4F46E5]/10 rounded-full mb-4">
              ...
              <div className="grid grid-cols-2 gap-3 max-w-lg mx-auto">
                {timeOptions.map((opt) => (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="px-5 py-4 rounded-xl border-2 border-[#e8eaf0] text-[#4a5568] hover:border-[#4F46E5] hover:bg-[#4F46E5]/5 transition-all duration-200 font-semibold text-sm"
                  >
                    {opt.label}
                  </motion.button>
                ))}
          ...
          {monthlyRevenue > 0 && (
            ...
            >
              <button
                ...
                className="bg-[#4F46E5] hover:bg-[#3730A3] text-white px-6 py-2.5 rounded-xl font-semibold transition-all duration-200 flex items-center gap-2 text-sm"
              >
                Continue
            ...
            <div className="text-center mb-8">
              ...
              <div className="grid grid-cols-2 gap-3 max-w-md mx-auto">
                <motion.button
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center justify-center gap-2 px-6 py-4 rounded-xl border-2 border-[#e8eaf0] text-[#4a5568] hover:border-[#4F46E5] hover:bg-[#4F46E5]/5 transition-all duration-200 font-semibold text-sm"
                >
