    ...
    <div className="w-full max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-5 pb-4 border-b border-slate-100">
          <div>
            <h2 className="text-xl md:text-2xl font-bold text-[#0F0E17] tracking-tight">
          ...
          <div className="hidden md:flex items-center gap-2 bg-slate-50 px-3 py-1.5 rounded-md border border-slate-100">
            <Shield className="w-3.5 h-3.5 text-[#0F0E17]" />
            <span className="text-xs font-medium text-[#0F0E17]">Bank-Grade Security</span>
          </div>
        </div>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-bold uppercase tracking-wider text-[#0F0E17]">
              Select Offer
            </span>
        ...
        <div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            ...
            <motion.button
              ...
              className={`relative text-left rounded-2xl border-2 p-5 transition-all cursor-pointer ${
                selected === 'standard'
                  ? 'border-[#0F0E17] bg-[#F8F9FB] shadow-sm'
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${
                  selected === 'standard' ? 'border-[#0F0E17] bg-[#0F0E17]' : 'border-slate-300'
                }`}>
                  {selected === 'standard' && <Check className="w-3 h-3 text-white" strokeWidth={3} />}
                </div>
              </div>

              <p className="text-[28px] font-bold text-[#0F0E17] mb-1.5 tabular-nums tracking-tight">
            ...
            <motion.button
              ...
              className={`relative text-left rounded-2xl border-2 p-5 transition-all cursor-pointer overflow-hidden ${
                selected === 'delt-preferred'
                  ? 'border-[#4F46E5] bg-gradient-to-br from-[#F5F5FF] to-[#EAECFF] shadow-md shadow-indigo-100'
                  : 'border-slate-200 hover:border-indigo-200'
              }`}
            >
              {/* Recommended badge */}
              <div className="absolute top-0 right-0">
                <div className="bg-[#4F46E5] text-white text-[9px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-bl-lg flex items-center gap-1">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] uppercase tracking-widest font-semibold text-[#4F46E5]">Delt Preferred</span>
                </div>
                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${
                  selected === 'delt-preferred' ? 'border-[#4F46E5] bg-[#4F46E5]' : 'border-slate-300'
                }`}>
              ...
              <div className="space-y-2 pt-3 border-t border-indigo-100">
                <div className="flex items-center gap-2 text-[11px] text-[#0F0E17]">
                  <div className="w-4 h-4 rounded-full bg-[#4F46E5]/10 flex items-center justify-center flex-shrink-0">
                    <TrendingUp className="w-2.5 h-2.5 text-[#4F46E5]" />
                  </div>
                  <span><strong className="text-[#4F46E5]">+{formatCurrency(deltHigh - standardHigh)}</strong> additional funding</span>
                </div>
                <div className="flex items-center gap-2 text-[11px] text-[#0F0E17]">
          ...
          <motion.button
            ...
            className="w-full py-3.5 rounded-xl bg-[#0F0E17] disabled:bg-slate-200 disabled:text-slate-400 text-white font-semibold text-sm transition-all cursor-pointer flex items-center justify-center gap-2"
          >
            {selected === 'delt-preferred'
