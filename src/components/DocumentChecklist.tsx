...
export function DocumentChecklist() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
      <div className="mb-8">
        <h3 className="text-2xl font-bold text-[#0F0E17] mb-2">Document Preparation Checklist</h3>
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-2">
          <p className="text-sm font-semibold text-[#0F0E17]">Required Documents Progress</p>
          <p className="text-sm font-bold text-[#4F46E5]">{completedCount} of {totalRequired}</p>
        </div>
        <div className="h-3 bg-gray-200 rounded-full overflow-hidden">
          <div 
            className="h-full bg-gradient-to-r from-[#4F46E5] to-[#3730A3] transition-all duration-500"
            ...
            <div 
              ...
              className={`border-2 rounded-xl p-6 transition-all ${
                checkedItems[doc.id] 
                  ...
                  : 'border-gray-200 bg-white hover:border-[#4F46E5]'
              }`}
            >
              <div className="flex items-start gap-4">
                ...
                >
                  {checkedItems[doc.id] ? (
                    ...
                    <Circle className="w-8 h-8 text-gray-400 hover:text-[#4F46E5]" strokeWidth={2} />
                  )}
                </button>
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      <h5 className="text-lg font-bold text-[#0F0E17]">{doc.name}</h5>
                      <p className="text-sm text-gray-600">{doc.category}</p>
                    </div>
                  </div>
                  <p className="text-gray-700 mb-3">{doc.description}</p>
                  <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                    <p className="text-sm font-semibold text-[#0F0E17] mb-2">Tips:</p>
      ...
      {/* Optional Documents */}
      <div className="mb-8">
        <h4 className="text-xl font-bold text-[#0F0E17] mb-4">Optional (But Helpful) Documents</h4>
        <div className="grid md:grid-cols-2 gap-4">
          {optionalDocs.map((doc) => (
            <div 
              key={doc.id}
              className="border border-gray-200 rounded-lg p-5 bg-gray-50 hover:border-[#4F46E5] transition-colors"
            >
              <div className="flex items-start gap-3">
                <span className="text-2xl">{doc.icon}</span>
                <div>
                  <h5 className="font-bold text-[#0F0E17] mb-1">{doc.name}</h5>
      ...
      <div className="bg-orange-50 border-l-4 border-orange-500 rounded-lg p-6 mb-8">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h4 className="font-bold text-[#0F0E17] mb-3">Common Document Issues to Avoid</h4>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div className="text-center p-6 bg-blue-50 rounded-xl">
          ...
          <h5 className="font-bold text-[#0F0E17] mb-2">Download from Bank</h5>
        ...
        <div className="text-center p-6 bg-purple-50 rounded-xl">
          ...
          <h5 className="font-bold text-[#0F0E17] mb-2">Use Good Lighting</h5>
        ...
        <div className="text-center p-6 bg-green-50 rounded-xl">
          ...
          <h5 className="font-bold text-[#0F0E17] mb-2">Double Check</h5>
          <p className="text-sm text-gray-600">Review for completeness before uploading</p>
        </div>
      </div>

      {/* CTA */}
      <div className="bg-gradient-to-r from-[#0F0E17] to-[#0a2d5a] rounded-xl p-8 text-white text-center">
        ...
        <button className="bg-[#4F46E5] hover:bg-[#3730A3] text-white px-8 py-4 rounded-xl font-semibold transition-colors">
          Start Application
        </button>
