    ...
    <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-2">
          ...
          <p className="text-sm font-bold text-[#4945ff]">{completedCount} of {totalRequired}</p>
        </div>
        <div className="h-3 bg-gray-200 rounded-full overflow-hidden">
          <div 
            className="h-full bg-gradient-to-r from-[#4945ff] to-[#3b38d9] transition-all duration-500"
            ...
            <div 
              ...
              className={`border-2 rounded-xl p-6 transition-all ${
                checkedItems[doc.id] 
                  ...
                  : 'border-gray-200 bg-white hover:border-[#4945ff]'
              }`}
            >
              <div className="flex items-start gap-4">
                ...
                >
                  {checkedItems[doc.id] ? (
                    ...
                    <Circle className="w-8 h-8 text-gray-400 hover:text-[#4945ff]" strokeWidth={2} />
                  )}
                </button>
      ...
      <div className="mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {optionalDocs.map((doc) => (
            <div 
              key={doc.id}
              className="border border-gray-200 rounded-lg p-5 bg-gray-50 hover:border-[#4945ff] transition-colors"
            >
      ...
      <div className="bg-gradient-to-r from-[#041e42] to-[#0a2d5a] rounded-xl p-8 text-white text-center">
        ...
        <button className="bg-[#4945ff] hover:bg-[#3b38d9] text-white px-8 py-4 rounded-xl font-semibold transition-colors">
          Start Application
        </button>
