...
export function MCACalculator() {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-6 md:p-8 border border-gray-200 dark:border-gray-700">
      <div className="mb-6">
        <h3 className="text-2xl font-bold text-[#172b4d] dark:text-white mb-2">MCA Cost Calculator</h3>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-8">
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <label className="text-sm font-semibold text-[#172b4d] flex items-center gap-2">
                <DollarSign className="w-4 h-4 text-[#0c66e4]" />
                Advance Amount
              </label>
              <span className="text-2xl font-bold text-[#0c66e4]">
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <label className="text-sm font-semibold text-[#172b4d] flex items-center gap-2">
                <TrendingUp className="w-4 h-4 text-[#0c66e4]" />
                Factor Rate
              </label>
              <span className="text-2xl font-bold text-[#0c66e4]">
        ...
        {/* Right Side - Results */}
        <div>
          <div className="bg-gradient-to-br from-[#0c66e4] to-[#0055cc] rounded-xl p-8 text-white mb-6">
                    ...
                    <button
                      ...
                      className={`px-3 py-1 rounded-md text-xs font-semibold transition-all ${
                        repaymentFrequency === 'daily'
                          ? 'bg-white text-[#0c66e4] shadow-md'
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4">
            <p className="text-sm text-[#172b4d] dark:text-white font-semibold mb-2">Important Note:</p>
          ...
          <div className="mt-6 flex gap-3">
            <button className="flex-1 bg-[#0c66e4] hover:bg-[#0055cc] text-white py-3 px-6 rounded-xl font-semibold transition-colors flex items-center justify-center gap-2">
              Apply Now
      ...
      <div className="mt-8 p-6 bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
        <h4 className="font-bold text-[#172b4d] dark:text-white mb-3">Understanding Your Costs</h4>
