  ...
  const renderFaqItem = (faq: { question: string; answer: string }, index: number, staggerIdx: number) => (
    ...
    >
      <div className="border-b border-gray-200 dark:border-gray-700 pb-6">
        ...
        >
          <span className="text-lg font-semibold text-[#0F0E17] dark:text-white group-hover:text-[#4F46E5] dark:group-hover:text-[#4F46E5] transition-colors">
            {faq.question}
          </span>
          <motion.div
    ...
    <section id="new-faq-section" ref={sectionRef} className="relative py-20 bg-white dark:bg-[#0D1B2A] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={titleRef} className="mb-12">
          <motion.h2
            className="text-4xl md:text-5xl font-bold text-[#0F0E17] dark:text-white"
