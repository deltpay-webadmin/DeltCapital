    ...
    <div className="fixed inset-0 bg-[#F7F5F0] z-50 overflow-y-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-16 relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-[#4F46E5]/5 to-transparent pointer-events-none"></div>
          
          <div className="relative z-10">
            {/* Badge */}
            <div className="flex justify-center mb-6">
              <div className="inline-flex items-center gap-2 bg-[#4F46E5]/10 text-[#4F46E5] px-4 py-2 rounded-full text-sm font-medium border border-[#4F46E5]/20">
                <Star className="w-4 h-4 fill-[#4F46E5]" />
                Trusted by 2,850+ merchants
              </div>
            </div>

            {/* Title */}
            <h1 className="text-4xl md:text-5xl font-bold text-[#0F0E17] text-center mb-4">
            ...
            <div className="flex items-center justify-center gap-2 mb-12">
              ...
              <span className="text-[#6A6876] text-lg ml-2">4.9/5 from 500+ reviews</span>
            </div>
            ...
            <div className="relative px-12">
              ...
              <button
                ...
                className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-[#0F0E17]/10 hover:bg-[#0F0E17]/20 rounded-full flex items-center justify-center transition-all hover:scale-110 backdrop-blur-sm"
                aria-label="Previous"
              >
                <ChevronLeft className="w-6 h-6 text-[#0F0E17]" />
              </button>

              {/* Next Button */}
              <button
                onClick={handleNext}
                className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-[#0F0E17]/10 hover:bg-[#0F0E17]/20 rounded-full flex items-center justify-center transition-all hover:scale-110 backdrop-blur-sm"
                aria-label="Next"
              >
                <ChevronRight className="w-6 h-6 text-[#0F0E17]" />
              </button>
              ...
              <div className="overflow-hidden">
                ...
                >
                  {reviews.map((review) => (
                    ...
                    >
                      <div className="bg-[#FFFFFF] border border-gray-100 rounded-2xl p-6 h-full">
                        {/* Stars */}
                        ...
                        {/* Quote */}
                        <p className="text-[#0F0E17] text-lg mb-6 min-h-[60px]">
                          "{review.quote}"
                        </p>
                        ...
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <div>
                            <div className="text-[#0F0E17] font-semibold">{review.name}</div>
                            <div className="text-[#6A6876] text-sm">{review.businessType}</div>
                          </div>
                        </div>

                        {/* Savings Badge */}
                        <div className="bg-[#4F46E5] text-white px-4 py-2 rounded-xl flex items-center justify-between">
            ...
            {onCalculatorClick && (
              <div className="mt-12 text-center">
                <p className="text-[#6A6876] mb-4 text-lg">
                ...
                <button
                  ...
                  className="bg-[#4F46E5] hover:bg-[#3730A3] text-white px-8 py-3 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl inline-flex items-center gap-2"
                >
