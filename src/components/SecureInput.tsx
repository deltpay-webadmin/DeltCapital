...
export function SecureInput({
  ...
  return (
    <div className="relative">
      ...
      <div className="relative">
        <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#6A6876]" />
        <input
          type="text"
          value={displayValue}
          onChange={(e) => {
        ...
        <button
          ...
          className="absolute right-3 top-1/2 -translate-y-1/2 text-[#6A6876] hover:text-[#4F46E5] transition-colors p-1 rounded focus:outline-none focus:ring-2 focus:ring-[#4F46E5]"
      ...
      <AnimatePresence>
        {showSecurityNotice && (
          <motion.div
            ...
            className="absolute z-50 mt-2 w-full bg-gradient-to-r from-[#4F46E5] to-[#4845FF] text-white p-4 rounded-lg shadow-xl border-2 border-[#4F46E5]"
          >
