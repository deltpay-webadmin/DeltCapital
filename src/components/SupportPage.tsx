    ...
    <div className="fixed inset-0 bg-[#F7F5F0] z-50 overflow-y-auto">
      ...
      <div className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-5xl md:text-6xl text-[#0F0E17] mb-6">
              We're here to <span className="text-[#4F46E5]">help</span>
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          ...
          <motion.div
            ...
            className="bg-white dark:bg-[#0F2744] rounded-xl p-5 shadow-sm hover:shadow-md transition-all cursor-pointer border border-gray-100 hover:border-[#4F46E5]/30 group"
          >
            <div className="w-12 h-12 bg-[#4F46E5]/10 rounded-full flex items-center justify-center mb-4 group-hover:bg-[#4F46E5]/15 transition-colors">
              <MessageCircle className="w-6 h-6 text-[#4F46E5]" />
            </div>
            <h3 className="text-lg text-[#0F0E17] dark:text-white mb-2">Live Chat</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Chat with our support team in real-time. Get instant answers to your questions.
            </p>
            <div className="flex items-center text-[#4F46E5] text-sm group-hover:gap-2 transition-all">
          ...
          >
            ...
            <h3 className="text-lg text-[#0F0E17] dark:text-white mb-2">Call Us</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Speak directly with a funding specialist. We're here to guide you through the process.
            </p>
            <div className="flex flex-col gap-2">
              <div className="text-lg font-bold text-[#4F46E5]">(864) 729-3358</div>
              <div className="flex items-center text-[#4F46E5] text-sm group-hover:gap-2 transition-all">
          ...
          >
            ...
            <h3 className="text-lg text-[#0F0E17] dark:text-white mb-2">Email Us</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Send us a detailed message and we'll get back to you within 24 hours.
            </p>
            <div className="flex flex-col gap-2">
              <div className="text-base font-semibold text-[#4F46E5]">info@deltcapital.com</div>
              <div className="flex items-center text-[#4F46E5] text-sm group-hover:gap-2 transition-all">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="text-lg text-[#0F0E17] dark:text-white">Support Hours</h3>
          </div>
          <div className="grid md:grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-[#0F2744] rounded-lg p-3">
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <span className="font-semibold text-sm text-[#0F0E17] dark:text-white">We're Online Now</span>
              </div>
        ...
        >
          <button
            ...
            className="w-full group relative bg-gradient-to-r from-[#0F0E17] to-[#4F46E5] rounded-2xl p-10 md:p-14 text-left transition-all hover:shadow-2xl hover:scale-[1.01] cursor-pointer"
          >
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-3 bg-white text-[#4F46E5] px-8 py-4 rounded-xl font-semibold text-lg flex-shrink-0 group-hover:bg-white/95 transition-colors">
                Book Now
