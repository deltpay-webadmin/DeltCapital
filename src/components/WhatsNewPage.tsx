    ...
    >
      ...
      >
        <div className="max-w-6xl mx-auto bg-white dark:bg-[#0A1F35] rounded-2xl shadow-2xl overflow-hidden">
          {/* Header */}
          <div className="bg-gradient-to-br from-[#0c66e4] via-[#4A47FF] to-[#1d7afc] text-white px-6 md:px-12 py-8 md:py-12 relative">
            <button
              onClick={onClose}
          ...
          <div className="p-6 md:p-12">
              ...
              {industryFacts.map((fact, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <span className="px-3 py-1 bg-[#0c66e4]/10 dark:bg-[#0c66e4]/20 text-[#0c66e4] dark:text-[#1d7afc] rounded-full text-sm font-semibold">
                      {fact.category}
                    </span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    {fact.stats.map((stat, idx) => (
                      <div 
                        key={idx}
                        className="bg-[#f1f2f4] dark:bg-[#0f1f2e] rounded-lg p-5 flex items-start gap-4"
                      >
                        <div className="text-[#0c66e4] dark:text-[#1d7afc] mt-1">
                          {stat.icon}
                        </div>
                        <div>
            ...
            {/* Footer CTA */}
            <div className="mt-12 bg-gradient-to-br from-[#0c66e4] via-[#4A47FF] to-[#1d7afc] rounded-2xl p-8 md:p-12 text-center text-white">
              ...
              <button
                onClick={onClose}
                className="bg-white text-[#0c66e4] hover:bg-gray-100 font-semibold px-8 py-3 rounded-lg transition-colors inline-flex items-center gap-2"
              >
