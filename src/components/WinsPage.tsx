...
export function WinsPage({ onClose, onAboutClick, onHowItWorksClick, onReviewsClick, onBlogClick, onFAQClick, onSupportClick, onWinsClick, onApplyClick, onQuizClick, onPrivacyClick, onTermsClick, onDisclosuresClick }: WinsPageProps) {
  ...
  return (
    <div className="fixed inset-0 bg-[#F7F5F0] dark:bg-[#0F0E17] z-50 overflow-y-auto">
      {/* Header */}
      <div className="sticky top-0 z-10 bg-[#F7F5F0] dark:bg-[#0a1929] border-b border-[#0F0E17]/10 dark:border-gray-700">
      ...
      {/* Hero Section */}
      <div className="bg-[#F7F5F0] dark:bg-[#0F0E17] pt-16 pb-12 md:pt-20 md:pb-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl text-[#0F0E17] dark:text-white mb-6 tracking-tight" style={{ fontWeight: 700 }}>
              The <em className="text-[#4F46E5] not-italic" style={{ fontStyle: 'italic' }}>relationship</em> is the point.
            </h1>
            ...
            return (
              <div key={index} className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#4F46E5] to-[#A78BFA] flex items-center justify-center">
              ...
              <div className="grid md:grid-cols-2 gap-0">
                ...
                <div className="p-8">
                  <div className="flex items-start gap-3 mb-6">
                    <Quote className="w-8 h-8 text-[#4F46E5] flex-shrink-0 opacity-50" />
                    <p className="text-gray-700 dark:text-gray-300 italic leading-relaxed">
                      "{story.quote}"
                    </p>
                  </div>

                  <div className="bg-gradient-to-br from-[#4F46E5]/5 to-[#A78BFA]/5 dark:from-[#4F46E5]/10 dark:to-[#A78BFA]/10 rounded-xl p-4 mb-6">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm text-gray-600 dark:text-gray-400">{t('wins.story.fundedAmount')}</span>
                      <span className="text-2xl font-bold text-[#4F46E5]">{story.fundingAmount}</span>
                    </div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      return (
                        <div key={idx} className="text-center">
                          <div className="flex justify-center mb-2">
                            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#4F46E5]/10 to-[#A78BFA]/10 flex items-center justify-center">
                              <MetricIcon className="w-5 h-5 text-[#4F46E5]" />
                            </div>
                          </div>
      ...
      {/* CTA Section */}
      <div className="bg-gradient-to-br from-[#4F46E5] via-[#7C3AED] to-[#A78BFA] py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="max-w-md mx-auto mb-6">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              />
              <Button 
                className="bg-white hover:bg-gray-100 text-[#4F46E5] font-semibold px-8 py-4 shadow-xl hover:shadow-2xl transition-all hover:scale-105 whitespace-nowrap"
              >
                Get Started
