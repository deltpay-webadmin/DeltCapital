export function BlogPostEcommerce() {
  return (
    <div className="prose prose-lg dark:prose-invert max-w-none">
      <img 
        src="https://images.unsplash.com/photo-1768987439378-9f6fe29ba975?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlY29tbWVyY2UlMjBvbmxpbmUlMjBzaG9wcGluZyUyMHBhY2thZ2VzfGVufDF8fHx8MTc3MDY2MTcwN3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" 
        alt="E-commerce packages" 
      ...
      <h2 className="text-3xl text-[#172b4d] dark:text-white mt-12 mb-4">The E-Commerce Capital Crunch</h2>
      <p>
      ...
      <h2 className="text-3xl text-[#172b4d] dark:text-white mt-12 mb-4">How E-Commerce Winners Use Revenue-Based Financing</h2>
      
      <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg my-8">
        <h3 className="text-2xl text-[#0c66e4] mb-4">Real E-Commerce Success</h3>
        <p className="mb-4">
        ...
        <p>
          <strong>Home Decor Store (Amazon FBA)</strong><br/>
          Q4 inventory investment of $65K. Sold through twice, reordered twice. $340K revenue that quarter vs $85K prior year. Now operates year-round instead of seasonally.
        </p>
      </div>

      <h2 className="text-3xl text-[#172b4d] dark:text-white mt-12 mb-4">Strategic E-Commerce Capital Deployment</h2>
      
      <ul className="space-y-4 my-6">
        <li><strong>Inventory Positioning:</strong> Amazon FBA, 3PL warehouses—inventory must be positioned before demand hits</li>
        <li><strong>Bulk Ordering:</strong> Container pricing vs air freight can double your margins. Need capital to order volume</li>
        <li><strong>Peak Season Preparation:</strong> Black Friday, Cyber Monday, holiday shopping—miss the window, miss the year</li>
        <li><strong>Viral Moment Capitalization:</strong> Social proof drives sales. Running out of stock kills momentum permanently</li>
        <li><strong>Ad Spend Scaling:</strong> Winning ad campaigns need immediate scaling budget before competition copies them</li>
      ...
      <h2 className="text-3xl text-[#172b4d] dark:text-white mt-12 mb-4">Revenue-Based Repayment = Perfect for Online Retail</h2>
      ...
      <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg my-8">
        <h3 className="text-2xl text-[#172b4d] dark:text-white mb-4">The Inventory ROI Calculation</h3>
        ...
        <p className="mb-2"><strong>Revenue Potential:</strong> $175,000</p>
        <p><strong>Profit After Advance & Costs:</strong> $80,000+</p>
      ...
      <h2 className="text-3xl text-[#172b4d] dark:text-white mt-12 mb-4">Never Miss Another Viral Moment</h2>
