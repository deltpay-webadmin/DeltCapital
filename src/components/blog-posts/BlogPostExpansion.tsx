export function BlogPostExpansion() {
  return (
    <div className="prose prose-lg dark:prose-invert max-w-none">
      ...
      <h2 className="text-3xl text-[#172b4d] dark:text-white mt-12 mb-4">Why Most Businesses Never Expand</h2>
      <p>
      ...
      <h2 className="text-3xl text-[#172b4d] dark:text-white mt-12 mb-4">The Multi-Location Advantage</h2>
      
      <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg my-8">
        <h3 className="text-2xl text-[#0c66e4] mb-4">Economies of Scale Kick In</h3>
        <ul className="space-y-2">
          ...
          <li>• Build brand recognition that drives traffic to all locations</li>
          <li>• Create career paths that help retain top employees</li>
          <li>• Develop systems and processes that increase profitability</li>
        </ul>
      </div>

      <h2 className="text-3xl text-[#172b4d] dark:text-white mt-12 mb-4">Revenue-Based Financing for Rapid Expansion</h2>
      ...
      <ul className="space-y-4 my-6">
        <li><strong>Lease Deposits & Rent:</strong> First, last, security—landlords want it immediately</li>
        <li><strong>Build-Out & Renovation:</strong> Creating the space, matching your brand, passing inspections</li>
        <li><strong>Initial Inventory:</strong> Stocking a new location requires significant upfront capital</li>
        <li><strong>Equipment & Furniture:</strong> POS systems, displays, seating, kitchen equipment</li>
        <li><strong>Staffing & Training:</strong> Hiring and training staff before opening day</li>
        <li><strong>Marketing & Launch:</strong> Grand opening campaigns to build immediate awareness</li>
      </ul>

      <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg my-8">
        <h3 className="text-2xl text-[#172b4d] dark:text-white mb-4">Case Study: Coffee Shop Chain</h3>
        ...
        <p className="mb-2"><strong>2025:</strong> $95K funding for location #4. Combined revenue: $2.1M</p>
      ...
      <h2 className="text-3xl text-[#172b4d] dark:text-white mt-12 mb-4">The Compounding Effect of Multiple Locations</h2>
      ...
      <h2 className="text-3xl text-[#172b4d] dark:text-white mt-12 mb-4">Strike While Markets Are Hot</h2>
