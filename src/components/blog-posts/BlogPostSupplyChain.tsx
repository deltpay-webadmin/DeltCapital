export function BlogPostSupplyChain() {
  return (
    <div className="prose prose-lg dark:prose-invert max-w-none">
      <img 
        src="https://images.unsplash.com/photo-1634638022229-5a52221886dc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdXBwbHklMjBjaGFpbiUyMGxvZ2lzdGljcyUyMHNoaXBwaW5nfGVufDF8fHx8MTc3MDY2MTcwOXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" 
      ...
      <h2 className="text-3xl text-[#0F0E17] dark:text-white mt-12 mb-4">The New Supply Chain Reality</h2>
      <p>
      ...
      <h2 className="text-3xl text-[#0F0E17] dark:text-white mt-12 mb-4">How Capital Solves Supply Chain Problems</h2>
      
      <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg my-8">
        <h3 className="text-2xl text-[#4F46E5] mb-4">Strategic Supply Chain Advantages</h3>
        <ul className="space-y-3">
          ...
          <li><strong>Alternative Suppliers:</strong> Capital enables switching to premium/reliable suppliers when primary sources fail</li>
          <li><strong>Safety Stock:</strong> Maintain 60-90 day inventory buffer instead of running on fumes</li>
          <li><strong>Container Deals:</strong> Book full containers at lower per-unit costs vs partial/air freight</li>
          <li><strong>Negotiating Power:</strong> Upfront payment gets better pricing and terms</li>
        </ul>
      </div>

      <h2 className="text-3xl text-[#0F0E17] dark:text-white mt-12 mb-4">Real Supply Chain Success</h2>
      
      <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg my-8">
        <h3 className="text-2xl text-[#0F0E17] dark:text-white mb-4">Case Study: Home Goods Importer</h3>
      ...
      <h2 className="text-3xl text-[#0F0E17] dark:text-white mt-12 mb-4">The Cash Payment Advantage</h2>
      ...
      <p>
        Net-30 or net-60 terms are convenient when supply is abundant. Cash is king when supply is constrained. MCA gives you the cash to be a priority customer.
      </p>

      <ul className="space-y-4 my-6">
        <li><strong>Production Priority:</strong> Cash customers get manufacturing slots before credit customers</li>
        <li><strong>Better Pricing:</strong> 2-5% discount for upfront payment compounds over time</li>
        <li><strong>Guaranteed Allocation:</strong> During shortages, cash customers get their orders</li>
        <li><strong>Faster Shipping:</strong> Express options available to priority customers</li>
        <li><strong>Quality Control:</strong> Leverage with suppliers = better quality oversight</li>
      </ul>

      <h2 className="text-3xl text-[#0F0E17] dark:text-white mt-12 mb-4">Building Resilient Supply Chains</h2>
      ...
      <h2 className="text-3xl text-[#0F0E17] dark:text-white mt-12 mb-4">Turning Disruption Into Market Share</h2>
