  ...
  return (
    <>
      ...
      <button
        ...
        className="xl:hidden fixed bottom-6 right-6 z-40 w-12 h-12 rounded-full bg-[#0c66e4] text-white shadow-lg shadow-[#0c66e4]/30 flex items-center justify-center hover:bg-[#1510d9] transition-colors"
  ...
  return (
    <button
      ...
      className={`
        ...
        ${isSubLevel ? 'pl-7' : ''}
        ${isActive
          ? 'bg-[#0c66e4]/8 text-[#0c66e4] font-semibold'
          : 'text-gray-500 dark:text-gray-400 hover:text-[#172b4d] dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800/50'
        }
      `}
    >
      <span
        className={`
          ...
          ${isActive ? 'bg-[#0c66e4] scale-100' : 'bg-transparent scale-0 group-hover:bg-gray-300 group-hover:scale-100'}
        `}
      />
        ...
        {hasToc ? (
          <div className="flex gap-10">
            ...
            <div className="flex-1 min-w-0 [&_h3]:scroll-mt-24 [&_h4]:scroll-mt-24" ref={contentRef}>
              <h1 className="text-3xl font-bold text-[#172b4d] dark:text-white mb-8">{title}</h1>
  ...
  return (
    <LegalPageLayout title="Privacy Policy" onClose={onClose} tocItems={privacyToc}>
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-[#172b4d] dark:text-white">DELT PAY LLC</h2>
        <p className="text-lg font-semibold text-[#172b4d] dark:text-white">Privacy Policy</p>
      ...
      <ul>
        <li>Plaid End User Privacy Policy: <a href="https://plaid.com/legal" target="_blank" rel="noopener noreferrer" className="text-[#0c66e4] underline">https://plaid.com/legal</a></li>
        <li>Plaid CRA Privacy Policy: <a href="https://plaid.com/plaid-check-consumer-report/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-[#0c66e4] underline">https://plaid.com/plaid-check-consumer-report/privacy-policy</a></li>
        <li>Plaid Biometric Policy and Release: <a href="https://plaid.com/legal/#biometric-policy" target="_blank" rel="noopener noreferrer" className="text-[#0c66e4] underline">https://plaid.com/legal/#biometric-policy</a></li>
      </ul>
      ...
      <h4 id="pp-3-1" className="font-bold text-[#172b4d] dark:text-white">3.1 Information You Provide Directly</h4>
      <ul>
      ...
      <h4 id="pp-3-2" className="font-bold text-[#172b4d] dark:text-white">3.2 Information Collected via Plaid</h4>
      ...
      <h4 id="pp-3-3" className="font-bold text-[#172b4d] dark:text-white">3.3 Information Collected via Plaid CRA (Consumer Reporting Data)</h4>
      ...
      <p>This data is used exclusively for permissible purposes under the FCRA, including evaluating your application for credit and assessing creditworthiness and repayment capacity. For more information about Plaid CRA's practices and your rights under the FCRA, please review the <a href="https://plaid.com/plaid-check-consumer-report/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-[#0c66e4] underline">Plaid CRA Privacy Policy</a>.</p>

      <h4 id="pp-3-4" className="font-bold text-[#172b4d] dark:text-white">3.4 Biometric Data (Collected via Plaid Identity Verification)</h4>
      ...
      <p>For full details on how Plaid collects, uses, stores, and deletes biometric data, please review <a href="https://plaid.com/legal/#biometric-policy" target="_blank" rel="noopener noreferrer" className="text-[#0c66e4] underline">Plaid's Biometric Policy and Release</a>.</p>
      <div className="bg-[#FFF8E1] border border-[#FFD54F] rounded-lg p-4 my-4">
        <p className="font-bold text-[#172b4d] mb-1">Special Notice for Illinois and Texas Residents:</p>
      ...
      <h4 id="pp-3-5" className="font-bold text-[#172b4d] dark:text-white">3.5 Information Collected Automatically</h4>
      ...
      <h4 id="pp-3-6" className="font-bold text-[#172b4d] dark:text-white">3.6 Information from Third Parties</h4>
      ...
      <h4 id="pp-5-1" className="font-bold text-[#172b4d] dark:text-white">5.1 Plaid and Plaid CRA</h4>
      ...
      <h4 id="pp-5-2" className="font-bold text-[#172b4d] dark:text-white">5.2 Service Providers</h4>
      ...
      <h4 id="pp-5-3" className="font-bold text-[#172b4d] dark:text-white">5.3 Legal and Regulatory Disclosures</h4>
      ...
      <h4 id="pp-5-4" className="font-bold text-[#172b4d] dark:text-white">5.4 Business Transfers</h4>
      ...
      <h4 id="pp-5-5" className="font-bold text-[#172b4d] dark:text-white">5.5 With Your Consent</h4>
      ...
      <p>We comply with the Safeguards Rule under the Gramm-Leach-Bliley Act ("GLBA"), which requires us to maintain a comprehensive information security program. While we work hard to protect your information, no system is completely secure. If you believe your information has been compromised, please contact us immediately at <a href="mailto:privacy@delt.com" className="text-[#0c66e4] underline">privacy@delt.com</a>.</p>
      ...
      <p className="font-bold text-[#172b4d] dark:text-white mt-4">Your Rights Under the FCRA</p>
      ...
      <p>To exercise your FCRA rights with Plaid CRA, you may visit <a href="https://plaid.com/check/consumer-service-center/" target="_blank" rel="noopener noreferrer" className="text-[#0c66e4] underline">Plaid CRA's Consumer Service Center</a> or contact Plaid CRA at 844-204-5860.</p>
      <p>To exercise any rights with Delt Pay, please contact us at <a href="mailto:privacy@delt.com" className="text-[#0c66e4] underline">privacy@delt.com</a>. We will respond within a reasonable time and in accordance with applicable law. We may require you to verify your identity before fulfilling a request.</p>
      ...
      <p>When you connect your financial accounts or undergo identity verification using Plaid, Plaid collects and processes your data as described in Plaid's End User Privacy Policy (<a href="https://plaid.com/legal" target="_blank" rel="noopener noreferrer" className="text-[#0c66e4] underline">https://plaid.com/legal</a>). You have rights with respect to Plaid's processing of your data directly with Plaid, including the ability to manage and revoke data connections through the Plaid Portal at <a href="https://my.plaid.com" target="_blank" rel="noopener noreferrer" className="text-[#0c66e4] underline">my.plaid.com</a>.</p>
      ...
      <p>You do not need to take any action to limit our sharing, as we already limit sharing to what is described in this Policy. If you have questions about our GLBA practices, contact us at <a href="mailto:privacy@delt.com" className="text-[#0c66e4] underline">privacy@delt.com</a>.</p>
      ...
      <p className="font-bold text-[#172b4d] dark:text-white mt-4">What Are Cookies</p>
      ...
      <p className="font-bold text-[#172b4d] dark:text-white mt-4">Types of Cookies We Use</p>
      <ul>
      ...
      <p className="font-bold text-[#172b4d] dark:text-white mt-4">Google reCAPTCHA</p>
      ...
      <div className="mt-4 mb-4">
        <p className="font-bold text-[#172b4d] dark:text-white">Delt Pay LLC</p>
        <p>Attn: Privacy</p>
        <p>1603 Capitol Ave Ste 415 #644712</p>
        <p>Cheyenne, Wyoming 82001 USA</p>
        <p>Email: <a href="mailto:privacy@delt.com" className="text-[#0c66e4] underline">privacy@delt.com</a></p>
      </div>
