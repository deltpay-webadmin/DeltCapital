...
// ── Delt brand tokens (matching calculator) ──
const C = {
  navy: "#0F1B3D",
  navyMid: "#1A2B55",
  purple: "#5B3FE4",
  purpleLight: "#7C6BF0",
  purpleDim: "rgba(91,63,228,0.08)",
  purpleGlow: "rgba(91,63,228,0.25)",
  blue: "#3B6BF7",
  green: "#22C55E",
  greenDim: "rgba(34,197,94,0.06)",
  white: "#FFFFFF",
  offWhite: "#F8F9FC",
  gray100: "#F1F3F8",
  gray200: "#E2E6F0",
...
// ── Label ──
function Label({ children, color = C.purple }) {
  return (
    <div style={{
...
// ── CTA Button ──
function CTAButton({ children, href = "#apply", secondary = false }) {
  ...
  return (
    <a href={href}
      ...
      style={{
        ...
        boxShadow: hovered && !secondary
          ? `0 8px 30px ${C.purpleGlow}`
          : "none",
        transition: "all 0.25s ease",
        cursor: "pointer",
      }}>
      {children}
      <span style={{ fontSize: 18, transition: "transform 0.2s", transform: hovered ? "translateX(3px)" : "none" }}>→</span>
    </a>
  );
}

// ── Stat block ──
function Stat({ value, label, color = C.purple }) {
  return (
...
export default function DeltLearnMore() {
  const [loaded, setLoaded] = useState(false);
  useEffect(() => { setLoaded(true); }, []);

  return (
    <div style={{
      fontFamily: "'DM Sans', 'Manrope', -apple-system, sans-serif",
      color: C.text,
      overflowX: "hidden",
    }}>
      {/* ═══════ HERO ═══════ */}
      <section style={{
        background: `linear-gradient(170deg, ${C.navy} 0%, ${C.navyMid} 60%, ${C.purple}22 100%)`,
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            <CTAButton>Get My Delt Offer</CTAButton>
            <CTAButton secondary href="#how-it-works">
        ...
        <div style={{
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <div style={{ fontSize: 28, fontWeight: 800, color: "rgba(255,255,255,0.4)", letterSpacing: -0.5 }}>$18K – $24K</div>
          </div>
          <div style={{
            width: 40, height: 40, borderRadius: 20,
            background: `linear-gradient(135deg, ${C.purple}, ${C.blue})`,
            display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: 18, color: C.white, fontWeight: 700, flexShrink: 0,
          }}>→</div>
          <div style={{ textAlign: "center" }}>
            <div style={{ fontSize: 11, fontWeight: 600, color: C.purpleLight, letterSpacing: 1.5, marginBottom: 6 }}>WITH DELT</div>
            <div style={{ fontSize: 28, fontWeight: 800, color: C.white, letterSpacing: -0.5 }}>$28K – $45K</div>
          </div>
        </div>
      </section>
      ...
      <Section bg={C.offWhite} style={{ padding: "40px 24px" }}>
        <div style={{
          ...
          {[
            ...
            { icon: "⚡", text: "No cancellation fees" },
            { icon: "✓", text: "Hassle-free switch" },
            { icon: "★", text: "0% on your first $5K" },
          ].map(t => (
      ...
      <Section bg={C.offWhite} id="how-it-works">
        ...
        <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
          {[
            {
              number: "1", icon: "📋", title: "Apply in 2 minutes",
            ...
            {
              number: "2", icon: "🔄", title: "We handle the switch",
            ...
            {
              number: "3", icon: "🚀", title: "Funding + processing go live",
      ...
      <Section>
        ...
        <div style={{ display: "flex", gap: 48, flexWrap: "wrap" }}>
          <div style={{ flex: "1 1 380px" }}>
            <Reveal delay={0}>
              <FeatureRow icon="💳" title="Interchange-plus pricing"
            ...
            <Reveal delay={80}>
              <FeatureRow icon="📊" title="Lens AI — real-time business intelligence"
            ...
            <Reveal delay={160}>
              <FeatureRow icon="💰" title="Priority capital access"
          ...
          <div style={{ flex: "1 1 380px" }}>
            <Reveal delay={60}>
              <FeatureRow icon="🖥" title="One dashboard for everything"
            ...
            <Reveal delay={140}>
              <FeatureRow icon="🌐" title="Professional website included"
            ...
            <Reveal delay={220}>
              <FeatureRow icon="🤝" title="Dedicated support"
